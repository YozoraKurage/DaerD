...
| **Bridge** | 外界への型非依存アクセサ | VrcParameters / VrcMenuAccess / VrcBehaviours / VrcParameterDriver（SDK 型を名前で）, ParameterStore（MA）, PrefabLinks / PrefabWriter（Check→純 Judge の前例）, LiveAnimator / AnimatorPlayback |
