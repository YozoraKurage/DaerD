...
{
    /// <summary>
    /// Persistent storage for graph frames (comment/group boxes drawn behind nodes).
    /// One hidden sub-asset per controller, created lazily on the first frame — controllers
    /// that never use frames are left untouched.
    /// </summary>
