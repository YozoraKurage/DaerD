    ...
    class LayersPanel : PanelBase
    {
        ...
        protected override void DrawContent()
        {
            ...
            for (int i = 0; i < layers.Length; i++)
            {
                ...
                // Anything DaerD generated, whatever generated it — one mark for every kind of
                // claim, with the tooltip naming each one: which setup, which recipe, how much
                // hangs in a shared host. There used to be SYNC and C# badges beside it saying
                // two of those in another way; the icon's own sentence already names them, and
                // a row that says the same thing twice is a row with less space for the layer.
                ...
                // The DBT badge stays, because it is not a claim: it says what the layer IS —
                // every state a Direct blend tree, the WD-ON idiom — and it appears on layers
                // somebody built by hand, which no owner mark ever covers.
