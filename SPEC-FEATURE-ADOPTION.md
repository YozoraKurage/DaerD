...
## 1. Network Sync ジェネレータ 【Beta に格下げ(2026-08-01)】

> **ステータス: Beta。** レイヤー全体をミラーする本機能は生成物が大きく、実運用での
> 有用性を再評価中。UI 上も「(Beta)」表記とし、生成構造は今後変わり得る。
> パラメーターの**値**を同期したい用途には §12 の巡回同期を推奨する。
...
## 12. 巡回同期(Round-Robin Sync / パラメーター圧縮) 【P1・追加】
